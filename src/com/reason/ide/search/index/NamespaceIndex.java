        ...
        return inputData -> {
            ...
            if (inputData.getFileType() instanceof DuneFileType) {
                ...
                if (configFile.hasNamespace()) {
                    Optional<Module> bsModule = ORModuleManager.findFirstBsModule(inputData.getProject());
                    Optional<VirtualFile> baseRoot = ORModuleManager.findBsConfigurationFile(bsModule.get());
